...
public class GeraQuestoes {
	...
	List<String> perguntasEstrutura = new ArrayList(Arrays.asList(
	        ...
	        "O que acontece se você usar a função realloc() para reduzir o tamanho de um bloco de memória?"
		));
	...
	List<String[]> respostasEstrutura = new ArrayList(Arrays.asList(
			...
			new String[]{
					   ...
					   "Verificando se há um número ímpar de parênteses em cada inserção.",
					   "Comparando os números de parênteses abertos e fechados.",
					   "Contando os parênteses à direita e à esquerda pela operação de remoção.",
					   "Não é possível verificar usando uma pilha porque a remoção é apenas no topo."},
			new String[]{"Criar uma pilha auxiliar, transferir os elementos e transferir de volta para a pilha original.",
					   ...
					   "Criar uma fila auxiliar, transferir para uma lista e transferir de volta para a pilha original.",
					   "Adicionar um elemento de controle no topo da pilha e inverter todos os elementos.",
					   "Retirando os elementos do topo e colocando na base com as operações da pilha."},
			...
			new String[]{"malloc() não inicializa a memória alocada, enquanto calloc() a inicializa com zero.",
					   ...
					   "malloc() aloca um bloco de memória por vez, enquanto calloc() aloca múltiplos.",
					   "calloc() aloca memória contígua, enquanto malloc() aloca memória não contígua.",
					   "Não há diferença entre malloc() e calloc(), ambos são idênticos no comportamento."},
			new String[]{"Capacidade dinâmica de crescimento.",
					   "Consumo de memória menor porque a memória é alocada em tempo de execução.",
					   "Facilidade de acesso a elementos aleatórios.",
					   "A lista possui um método que ordena automaticamente, enquanto o array não",
					   "O array possui um método que ordena automaticamente, enquanto a lista não."},
			new String[]{"Facilidade em acessar elementos na ordem inversa.",
					   "Facilidade em remover os elementos sem conflitos.",
					   "No último nó da lista duplamente encadeada temos acesso ao nó inicial.",
			...
			new String[]{"Possibilidade de percorrer a lista indefinidamente sem encontrar um nó NULL.",
					   "Facilidade em acessar elementos na ordem inversa com o método previousElement.",
					   "Remover todos os elementos na ordem inversa.",
					   "Capacidade dinâmica de crescimento.",
			...
			new String[]{"Capacidade de alocar memória conforme necessário durante a execução.",
					   "Criar arrays estáticos que podem ser fila/pilha/lista.",
					   "Utilizar ponteiro para alterar o conteúdo do endereço de memória.",
					   "Manipular as variáveis pelo ponteiro ao invés de alterar diretamente pela variável.",
					   "Capacidade de alocar memória conforme necessário durante a compilação."},
			new String[]{
						"Cria um novo bloco de memória com o tamanho desejado e copia os dados do bloco original para o novo bloco.",
						"Reduz o tamanho do bloco de memória para o valor especificado sem criar novos blocos de memória.",
						"Gera um erro de compilação.",
						"Retorna NULL, o realloc é usado para aumentar o tamanho de um bloco de memória.",
						"Não pode ser usada para reduzir o tamanho de um bloco de memória."}
			));
	...
	List<String[]> respostasJava = new ArrayList(Arrays.asList(
			...
			new String[]{
					"throw lança uma exceção durante a execução do código, enquanto throws declara uma exceção no método.",
					"throws declara uma exceção no método, enquanto throw lança uma exceção durante a execução do código.",
			...
			new String[]{
					"Uma anotação usada para mapear uma URL.",
					"Uma anotação usada para definir um Controller que terá mais endpoints dentro dele.",
			...
			new String[]{
					...
					"Não, Java não suporta herança múltipla nem interfaces múltiplas porque viola o ACID.",
			...
			new String[]{
					"Uma ferramenta online para gerar um esqueleto de projeto Spring Boot personalizado com base nas dependências.",
